...
4G_ATG_ENB8_UDP_BIDI
    [Tags]    4G_ATG_ENB8_UDP_BIDI
    ...
    Start enb8 UE log collection_usernameSVG     ${pi_ip}
    ${ue_state}=    UDP BIDI    ${pi_ip}

    Sleep     ${DURATION}
    Stop enb8 UE log collection_usernameSVG      ${pi_ip}
    ATG_4G_bs Log Collection    ${eNB9}      4G_ATG_ENB8_UDP_BIDI
    #ATG_4G_RU_bs Log Collection    ${RU_eNB9}    4G_ATG_ENB9_TA_SWEEP
    ATG_4G_L1 log collection      ${eNB9}      4G_ATG_ENB8_UDP_BIDI
